...
par(mar=c(4,4,1,1))
plot(mat.dist$mids, cumsum(mat.dist$counts), type='l', col='black', xlab='Dorsomedial-Ventrolateral (µm)', ylab='Cumulative tdTomato cells', axes=FALSE, ylim=c(0,1000))
